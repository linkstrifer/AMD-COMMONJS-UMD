...
// var messages = require('./modules/messages-commonjs');
var messages = require('./modules/messages-umd');

messages.success('Success message');
messages.error('Error message');
messages.info('Info message');
},{"./modules/messages-umd":2,"jquery":3}],2:[function(require,module,exports){
